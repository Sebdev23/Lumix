...
export function ChatPage() {
  ...
  // Crece con el contenido (como ya hace EditableText en Minuta): con rows={1} fijo, un
  // mensaje de mas de una linea quedaba con scroll interno apenas visible -"se pierde de
  // vista lo que estamos escribiendo", bug real reportado por Sebastian probando en el
  // celular-. Tope en ~6 lineas (160px) para que no se coma toda la pantalla si alguien
  // pega un texto largo; de ahi para arriba, scroll interno normal.
  useEffect(() => {
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-end gap-2">
              <textarea
                ...
                // max-h-40 + overflow-y-auto: limite del auto-resize de arriba (160px).
                className="flex-1 resize-none overflow-y-auto max-h-40 rounded-xl border border-border-strong bg-panel px-4 py-2.5 text-base text-fg placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500"
              />
              <Button
                size="sm"
