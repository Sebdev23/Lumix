...
```bash
curl -X POST https://dviowymbowuhbwqcaaye.supabase.co/functions/v1/ai-classify \
...
```
VITE_SUPABASE_URL=https://dviowymbowuhbwqcaaye.supabase.co
VITE_SUPABASE_ANON_KEY=sb_publishable_bE8vYaR8KoiJ-2FYWM3FIA_mKA2uTZg
```
...
PROJECT_URL=https://dviowymbowuhbwqcaaye.supabase.co
```
